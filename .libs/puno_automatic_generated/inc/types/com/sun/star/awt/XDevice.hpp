...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::awt::XDevice > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::awt::XDevice > >::get();
}

::css::uno::Type const & ::css::awt::XDevice::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::awt::XDevice >::get();
}
