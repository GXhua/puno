...
SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::embed::XOptimizedStorage > const *) {
    return ::cppu::UnoType< ::css::uno::Reference< ::css::embed::XOptimizedStorage > >::get();
}

::css::uno::Type const & ::css::embed::XOptimizedStorage::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::cppu::UnoType< ::css::embed::XOptimizedStorage >::get();
}
