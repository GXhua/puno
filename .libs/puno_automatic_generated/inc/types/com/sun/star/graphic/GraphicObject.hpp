...
public:
    ...
    static ::css::uno::Reference< ::css::graphic::XGraphicObject > createWithId(::css::uno::Reference< ::css::uno::XComponentContext > const & the_context, const ::rtl::OUString& uniqueId) {
        ...
        try {
#if defined LO_URE_CURRENT_ENV && defined LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_graphic_dot_GraphicObject && (LO_URE_CURRENT_ENV) == (LO_URE_CTOR_ENV_com_dot_sun_dot_star_dot_graphic_dot_GraphicObject) && defined LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_graphic_dot_GraphicObject
            the_instance = ::css::uno::Reference< ::css::graphic::XGraphicObject >(::css::uno::Reference< ::css::uno::XInterface >(static_cast< ::css::uno::XInterface * >((*LO_URE_CTOR_FUN_com_dot_sun_dot_star_dot_graphic_dot_GraphicObject)(the_context.get(), the_arguments)), ::SAL_NO_ACQUIRE), ::css::uno::UNO_QUERY);
            ::css::uno::Reference< ::css::lang::XInitialization > init(the_instance, ::css::uno::UNO_QUERY);
            if (init.is()) {
                init->initialize(the_arguments);
            }
#else
            the_instance = ::css::uno::Reference< ::css::graphic::XGraphicObject >(the_context->getServiceManager()->createInstanceWithArgumentsAndContext( "com.sun.star.graphic.GraphicObject", the_arguments, the_context), ::css::uno::UNO_QUERY);
#endif
        } catch (const ::css::uno::RuntimeException &) {
            throw;
        } catch (const ::css::uno::Exception & the_exception) {
